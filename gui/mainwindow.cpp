...
void MainWindow::showAboutDialog()
{
    QMessageBox::about(this, tr("About Cantata"),
                       tr("<b>Cantata %1</b><br/><br/>MPD client.<br/><br/>"
                           "&copy; 2011-2022 Craig Drummond<br/>Built by Manvendra Bhangui <cantata@indimail.org><br/>Released under <a href=\"http://www.gnu.org/licenses/gpl.html\">GPLv3</a> license").arg(PACKAGE_VERSION_STRING)+
                       QLatin1String("<br/><br/>")+
                       tr("refer to <a href=\"https://github.com/mbhangui/cantata\">Cantata's github page </a> for the source.")+
